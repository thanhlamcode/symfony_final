...
use App\Api\State\CouponOrder\CreateCouponOrderProcessor;
...
#[Post(
    uriTemplate: '/couponorders.{_format}',
    ...
    processor: CreateCouponOrderProcessor::class
)]
final readonly class CreateCouponOrder
{
