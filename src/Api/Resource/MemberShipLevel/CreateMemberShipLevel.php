...
use App\Api\State\MemberShipLevel\CreateMemberShipLevelProcessor;
...
#[Post(
    uriTemplate: '/membershiplevels.{_format}',
    ...
    processor: CreateMemberShipLevelProcessor::class
)]
final readonly class CreateMemberShipLevel
{
