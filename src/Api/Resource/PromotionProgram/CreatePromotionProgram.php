...
use App\Api\State\PromotionProgram\CreatePromotionProgramProcessor;
...
#[Post(
    uriTemplate: '/promotionprograms.{_format}',
    ...
    processor: CreatePromotionProgramProcessor::class
)]
final readonly class CreatePromotionProgram
{
