...
use App\Api\State\ReturnOrder\UpdateReturnOrderProcessor;
...
#[Patch(
    uriTemplate: '/returnorders/{id}.{_format}',
    ...
    processor: UpdateReturnOrderProcessor::class
)]
final readonly class UpdateReturnOrder
{
