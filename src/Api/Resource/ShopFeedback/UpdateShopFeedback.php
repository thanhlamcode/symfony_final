...
use App\Api\State\ShopFeedback\UpdateShopFeedbackProcessor;
...
#[Patch(
    uriTemplate: '/shopfeedbacks/{id}.{_format}',
    ...
    processor: UpdateShopFeedbackProcessor::class
)]
final readonly class UpdateShopFeedback
{
