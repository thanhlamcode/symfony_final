...
use App\Api\State\ShopSetting\UpdateShopSettingProcessor;
...
#[Patch(
    uriTemplate: '/shopsettings/{id}.{_format}',
    ...
    processor: UpdateShopSettingProcessor::class
)]
final readonly class UpdateShopSetting
{
