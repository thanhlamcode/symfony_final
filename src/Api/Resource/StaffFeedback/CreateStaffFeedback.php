...
use App\Api\State\StaffFeedback\CreateStaffFeedbackProcessor;
...
#[Post(
    uriTemplate: '/stafffeedbacks.{_format}',
    ...
    processor: CreateStaffFeedbackProcessor::class
)]
final readonly class CreateStaffFeedback
{
