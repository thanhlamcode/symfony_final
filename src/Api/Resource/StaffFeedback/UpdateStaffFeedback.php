...
namespace App\Api\Resource\StaffFeedback;

use ApiPlatform\Metadata\ApiProperty;
use ApiPlatform\Metadata\Patch;
use ApiPlatform\OpenApi\Model\Operation;
use App\Api\State\StaffFeedback\UpdateStaffFeedbackProcessor;
...
#[Patch(
    uriTemplate: '/stafffeedbacks/{id}.{_format}',
    ...
    output: StaffFeedback::class,
    processor: UpdateStaffFeedbackProcessor::class
)]
final readonly class UpdateStaffFeedback
{
